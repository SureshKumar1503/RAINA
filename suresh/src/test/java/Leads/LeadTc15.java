...
public class LeadTc15 extends LeadsClass{
	@Test
	public void Tc10(){
		driver.findElement(By.name("lastname")).sendKeys("kirish");
		driver.findElement(By.name("company")).sendKeys("testyantra");
		driver.findElement(By.name("annualrevenue")).sendKeys("1000000");
		driver.findElement(By.name("noofemployees")).sendKeys("10000");
		driver.findElement(By.id("email")).sendKeys("sweetarpita91@gmail.com");
		driver.findElement(By.id("secondaryemail")).sendKeys("sumbit07@gmail.com");
